...
let CreateNew = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    setAuthor('')
    setInfo('')
    // component gets access to history-props after it is wrapped by the function withRouter
    props.history.push("/") // results in the address bar of the browser changing its address to / which displays list of anecdotes
  }
